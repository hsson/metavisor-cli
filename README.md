[![Build Status](https://travis-ci.org/immutable-systems/metavisor-cli.svg?branch=master)](https://travis-ci.org/immutable-systems/metavisor-cli)

# metavisor-cli
The `metavisor-cli` is a command-line interface to easily deploy cloud instances with the Metavisor.

The latest release of **metavisor-cli** is [1.0.0](https://github.com/immutable-systems/metavisor-cli/releases/latest).
...
#### Linux
```
$ curl -L -o ./metavisor https://github.com/immutable-systems/metavisor-cli/releases/download/v1.0.0/metavisor-linux
$ chmod +x ./metavisor
...
#### macOS
```
$ curl -L -o ./metavisor https://github.com/immutable-systems/metavisor-cli/releases/download/v1.0.0/metavisor-darwin
$ chmod +x ./metavisor
$ sudo mv ./metavisor /usr/local/bin/metavisor
```
...
```
$ curl -L -o ./metavisor.exe https://github.com/immutable-systems/metavisor-cli/releases/download/v1.0.0/metavisor-windows.exe
```
or, simply download by using this link: [Download CLI](https://github.com/immutable-systems/metavisor-cli/releases/download/v1.0.0/metavisor-windows.exe). 
